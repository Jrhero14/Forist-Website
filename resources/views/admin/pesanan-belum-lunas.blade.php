                    ...
                    <div class="col-span-3">
                        <nav class="-mb-0.5 flex space-x-6 border-b-2">
                            <a class="py-4 px-1 inline-flex items-center gap-2 border-b-2 border-blue-500 text-sm font-medium whitespace-nowrap text-blue-600 focus:outline-none focus:text-blue-800"
                               href="/admin/pesanan/belum-lunas" aria-current="page">
                                Belum Lunas <span
                                    class="ms-1 py-0.5 px-1.5 rounded-full text-xs font-medium bg-blue-100 text-blue-600 dark:bg-blue-500 dark:text-white">{{ $total_pesanan_belum_lunas }}</span>
                            </a>
                            ...
                            <a class="py-4 px-1 inline-flex items-center gap-2 border-b-2 border-gray-100 text-sm font-medium whitespace-nowrap text-gray-600 focus:outline-none focus:text-blue-800"
                               href="/admin/pesanan/selesai" aria-current="page">
                                Selesai <span
                                    class="ms-1 py-0.5 px-1.5 rounded-full text-xs font-medium bg-gray-100 text-gray-600 dark:bg-blue-500 dark:text-white">{{ $total_pesanan_selesai }}</span>
                            </a>
                        </nav>
