            ...
            <form class="grid grid-cols-3" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-span-1 border-2 h-[20rem] relative">
                    <img class="h-full w-full object-cover input-img mb-3"
                        src="https://www.shutterstock.com/image-vector/image-photo-jpg-file-mountains-260nw-2171954979.jpg"
                        alt="">
                    <label>
                ...
                <div class="col-span-2 flex flex-col gap-y-4 px-5">
                    ...
                    <input name="namaproduct" type="text" class="p-1 px-2 border-2 border-stone-400 rounded-lg">
                    ...
                    <input name="hargasatuan" type="number" class="p-1 px-2 border-2 border-stone-400 rounded-lg">

                    <label for="" class="font-medium">Stock</label>
                    <input name="stock" type="number" class="p-1 px-2 border-2 border-stone-400 rounded-lg">
                    ...
                    <button type="submit"
                        class="w-full p-1 bg-stone-500 hover:bg-stone-600 text-white font-medium rounded-lg">Tambah
                        Product</button>
                </div>
            </form>
        </div>
