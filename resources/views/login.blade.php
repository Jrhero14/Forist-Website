...
<div class="h-screen w-screen">
    <div class="flex h-screen w-screen justify-center items-center">
        <div class="relative grid p-5 lg:p-0 lg:grid-cols-2 w-screen max-w-[60rem]">
            ...
            <div class="bg-white p-10">
                <div class="mb-5">
                    ...
                    <p class="text-lg font-light">We are happy to see you again😄</p>
                </div>
                ...
                <div>
                    <form method="post">
                        ...
                        <button type="submit"
                            class="mt-4 p-2 bg-stone-700 text-white hover:bg-stone-900 w-full font-bold">Login</button>
                        <p class="mt-4 text-center">Belum punya akun? <a href="/register"
                                                                         class="text-blue-500 hover:text-blue-700 underline underline-offset-1">Register</a>
                        </p>
                    </form>
                </div>
            </div>
